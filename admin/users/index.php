            ...
            <div class="posts col-9">
               <div class="button row d-flex justify-content-end mb-5">
                  ...
                  <a href="<?php echo BASE_URL . "admin/users/index.php"; ?>"
                     class="col-2 btn btn-warning">Управление</a>
               </div>

               <div class="row title-table fw-bold">
                  <h4 class="mb-4 text-center">Управление пользователями</h4>
               ...
               <div class="row post">
                  ...
                  <div class="title col-5">amir2002</div>
               ...
               <div class="row post">
                  ...
                  <div class="title col-5">user2005</div>
               ...
               <div class="row post">
                  <div class="id col-1">1</div>
                  <div class="title col-5">user123</div>
                  <div class="author col-4">Admin</div>
                  <div class="edit col-1 text-center"><a href="">Edit</a></div>
                  <div class="del col-1 text-center"><a href="">Delete</a></div>
               </div>
